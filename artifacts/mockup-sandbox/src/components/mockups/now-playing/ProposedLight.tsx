...
function IconInfo({ size = 16, color = "#E98D32" }) {
  return (
...
function IconPause({ size = 18, color = "#E98D32" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function IconSkip({ size = 18, color = "#E98D32" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ width: 420 }}>
        ...
        <div style={{
          ...
          <button style={iconBtn}>
            <IconInfo size={16} color={light.primary} />
          </button>
          <button style={iconBtn}>
            <IconPause size={18} color={light.primary} />
          </button>
          <button style={iconBtn}>
            <IconSkip size={18} color={light.primary} />
          </button>
        </div>
      </div>
    </div>
