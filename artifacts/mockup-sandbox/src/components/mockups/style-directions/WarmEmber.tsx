        ...
        <header className="px-6 pt-4 pb-6 shrink-0">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="text-stone-400 hover:text-stone-200 hover:bg-stone-800/50 rounded-full"
            >
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-24 flex flex-col gap-4 no-scrollbar">
          ...
          <button className="w-full text-left group outline-none">
            <div className="p-5 rounded-2xl bg-stone-800/40 border border-stone-700/50 backdrop-blur-md transition-all duration-300 group-hover:bg-stone-800/60 group-hover:border-orange-900/50 group-hover:shadow-[0_0_20px_rgba(194,65,12,0.15)] group-active:scale-[0.98]">
              ...
              <p className="text-sm text-stone-400 leading-relaxed mb-4 line-clamp-2">
                Behind this unassuming brick facade lies one of the city's
                earliest operational speakeasies, completely preserved.
              </p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <Badge
                    variant="outline"
                    className="bg-stone-900/50 text-stone-300 border-stone-700/50 font-medium"
                  >
                    1922
                  </Badge>
                  <Badge
          ...
          <button className="w-full text-left group outline-none">
            <div className="p-5 rounded-2xl bg-stone-800/40 border border-stone-700/50 backdrop-blur-md transition-all duration-300 group-hover:bg-stone-800/60 group-hover:border-orange-900/50 group-hover:shadow-[0_0_20px_rgba(194,65,12,0.15)] group-active:scale-[0.98]">
              ...
              <p className="text-sm text-stone-400 leading-relaxed mb-4 line-clamp-2">
                Look closely at the sidewalk—you can still see the embedded
                brass markers where the legendary punk club's entrance once
                stood.
              </p>
          ...
          <button className="w-full text-left group outline-none">
            <div className="p-5 rounded-2xl bg-stone-800/40 border border-stone-700/50 backdrop-blur-md transition-all duration-300 group-hover:bg-stone-800/60 group-hover:border-orange-900/50 group-hover:shadow-[0_0_20px_rgba(194,65,12,0.15)] group-active:scale-[0.98]">
              ...
              <p className="text-sm text-stone-400 leading-relaxed mb-4 line-clamp-2">
                Before the famous neon, a hand-painted wooden sign hung here.
                The faded letters are still visible when the light hits just
                right.
              </p>
