          ...
          <div className="flex-1 overflow-y-auto pb-24 px-4 pt-4 space-y-4">
            ...
            <div className="group relative bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl p-5 hover:border-teal-500/50 transition-colors cursor-pointer">
              ...
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                Originally the headquarters of the Jewish Daily Forward, a
                prominent Yiddish-language socialist newspaper. Its Beaux-Arts
                facade hides a history of radical labor organizing.
              </p>

              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <span className="px-2 py-1 rounded bg-slate-800/80 text-slate-300 text-xs font-medium border border-slate-700">
                    Built 1912
                  </span>
                  <span className="px-2 py-1 rounded bg-slate-800/80 text-slate-300 text-xs font-medium border border-slate-700">
                    Beaux-Arts
            ...
            <div className="group relative bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl p-5 hover:border-amber-500/50 transition-colors cursor-pointer">
              ...
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                Founded by Sender Jarmulowsky to serve Jewish immigrants. The
                12-story Beaux-Arts tower was the tallest on the Lower East Side
                when completed.
              </p>
            ...
            <div className="group relative bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl p-5 hover:border-teal-500/50 transition-colors cursor-pointer">
              ...
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                Originally built as a Methodist Episcopal Church from
                fieldstone. It later became a synagogue and allegedly served as
