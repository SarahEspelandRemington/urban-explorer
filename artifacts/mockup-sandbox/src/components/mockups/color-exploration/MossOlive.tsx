  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <TreePine size={40} color={colors.primary} strokeWidth={1.5} />
        </div>
      ...
      >
        ...
        >
          <TreePine size={22} color={colors.primary} strokeWidth={1.8} />
          <span
            style={{
              fontSize: 11,
              fontWeight: 600,
