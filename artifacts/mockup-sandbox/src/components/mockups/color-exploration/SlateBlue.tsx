import { Layers, Search, Headphones, Navigation, Bookmark } from "lucide-react";

const colors = {
  background: "#F2F4F6",
  card: "#FFFFFF",
  foreground: "#2A2F35",
  mutedForeground: "#5C636B",
  primary: "#4A6B8A",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Layers size={40} color={colors.primary} strokeWidth={1.5} />
        </div>
